...
var RateBucketSchema = new mongoose.Schema({
    createdAt: {type: Date, required: true, default: Date.now, expires: config.staging.rateLimits.ttl},
    ...
    hits: {type: Number, default: 1, required: true, max: config.staging.rateLimits.maxHits, min: 0}
});
